...
public final class BasicFormattingParser implements TextFormattingParser {
    ...
    public FormattingKit parseFormattings(MarkedUpText markedUpText, FormatParsingRuleset rules) {
        ...
        for (FormatParsingRule rule : rules) {
            ...
            int matchStartIndex, matchLastIndex, replacementTextLength;
            ...
            while (regexMatcher.find()) {
                ...
                matchLastIndex = regexMatcher.end() - 1;
                ...
                MarkedUpText matchedText = new MarkedUpText(
                        workingText.substring(matchStartIndex, matchLastIndex + 1), markedUpText.getMarkupLanguages());
                ...
                workingText = workingText.substring(0, matchStartIndex + 1) + // Original prefix
                        ...
                        workingText.substring(matchLastIndex + 1); // Original suffix
                ...
                int parsingDisplacement = replacementTextLength - matchedText.getText().length();
                ...
                instructions.add(0,
                        new FormattingInstruction(locationInFullStr, generatedFormatting, parsingDisplacement));
            }
