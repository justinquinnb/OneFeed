...
public class BasicFormattingIndexer implements TextFormattingIndexer {
    ...
    public <T extends TextFormatting> FormattingKit<T> buildKitFor(
            String markedUpText, FormattingRuleset<T> formattingRules) {
        ...
        for (FormattingRule<T> rule : formattingRules) {
            ...
            while (regexMatcher.find()) {
                ...
                instructions.add(new FormattingInstruction<T>(locationInOgStr, generatedFormatting));
            }
        }
